...
Future<dynamic> getAllCollabRequests(String token, String collabId) async {
  ...
  var request = http.Request(
      'GET',
      Uri.parse(
          'http://192.168.0.131:3000/api/getAllCollabRequestForACampJob/' +
              collabId));
...
Future<dynamic> rejectCollabRequest(
  ...
  var request = http.Request(
      'PUT',
      Uri.parse(
          'http://192.168.0.131:3000/api/rejectCollabRequestForACampJob'));
  request.body =
...
Future<dynamic> acceptCollabRequest({
  ...
  var request = http.Request(
      'POST', Uri.parse('http://192.168.0.131:3000/api/acceptUsersRequest'));
