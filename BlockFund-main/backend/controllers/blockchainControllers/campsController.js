...
const rpcURL = 'https://sepolia.infura.io/v3/b182095e60fe47338e785c8c4dd9ae15';
...
const createCamp = async(req,res)=>{
    ...
    try{
        ...
        const image_url = `http://192.168.0.131:3000/media/camp/${req.file.filename}`;
       ...
       const raw = '0x' + serializedTx.toString('hex')
        ...
        // const tx = new Tx(txObject,{chain:11155111})
        // tx.sign(privateKey)
...
const buyEquity = async(req,res)=>{
    try{
        ...
        const common = new Common({ chain:11155111 })
       const tx1 = Transaction.fromTxData(txObject1, { common })

       const signedTx1=tx1.sign(privateKey1)
       const serializedTx1 = signedTx1.serialize()
       const raw1 = '0x' + serializedTx1.toString('hex')
    
        // Sign the transaction
        // const tx1 = new Tx(txObject1,{chain:11155111})
        ...
        //const common = new Common({ chain:11155111 })
       const tx2 = Transaction.fromTxData(txObject2, { common })

       const signedTx2=tx2.sign(owner_private_key)
       const serializedTx2 = signedTx2.serialize()
       const raw2 = '0x' + serializedTx2.toString('hex')
    
        // Sign the transaction
        // const tx2 = new Tx(txObject2,{chain:11155111})
        ...
        //const common = new Common({ chain:11155111 })
       const tx3 = Transaction.fromTxData(txObject3, { common })

       const signedTx3=tx3.sign(owner_private_key)
       const serializedTx3 = signedTx3.serialize()
       const raw3 = '0x' + serializedTx3.toString('hex')
        // Sign the transaction2
        // const tx3 = new Tx(txObject3,{chain:11155111})
        ...
        //const common = new Common({ chain:11155111 })
       const tx4 = Transaction.fromTxData(txObject4, { common })

       const signedTx4=tx4.sign(privateKey)
       const serializedTx4 = signedTx4.serialize()
       const raw4 = '0x' + serializedTx4.toString('hex')
        // Sign the transaction
        // const tx4 = new Tx(txObject4,{chain:11155111})
        // tx4.sign(privateKey)
