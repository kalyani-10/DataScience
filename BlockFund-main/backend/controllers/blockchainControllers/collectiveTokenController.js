    ...
    try{
        ...
        if(!ctvBalance || !ethBalance){
            return res.status(500).json({
                result:false,
                msg:'There was a problem fetching the users account balance 63'
            })
        }
        ...
        res.status(500).json({
            result:false,
            msg:'There was a problem fetching the users account balance 79'
        })
    }
}
...
const getUsersAccountBalance = async(req,res)=>{
    try{
        ...
        console.log(ctvBalance)
        console.log(ethBalance)

        if(!ctvBalance || !ethBalance){
            return res.status(500).json({
                result:false,
                msg:'There was a problem fetching the users account balance 94'
            })
        }
